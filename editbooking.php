...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid" style="background-color: #E5E7E9;">
        <div class="menubody">
            <div class="editbbox">
                <p class="headfont al-left">Edit Booking</p>
                <span class="descfont">by Dararat Kamphasuk, staff position</span>
                    ...
                    <form class="al-left">
                        ...
                        <table class="servicetab">
                            <tr>
                                <form action="#">
                                    <td>
                                        <input type="radio" id="room" name="service_type" value="room">
                                    ...
                                    <td>
                                        <input type="button" value="Available Check"></input>
                                    </td>
                                    <td>
                                        <div> </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" id="restaurant" name="service_type" value="restaurant">
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" id="hall" name="service_type" value="hall">
                ...
                <div class="al-right calc">
                    <button>Bill Information</button>
                    <hr>
                    <table>
                        <tr>
                            <td>
